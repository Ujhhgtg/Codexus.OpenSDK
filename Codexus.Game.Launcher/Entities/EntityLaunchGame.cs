...
public class EntityLaunchGame
{
    ...
    [JsonPropertyName("game_version_id")] public int GameVersionId { get; set; }
    ...
    [JsonPropertyName("max_game_memory")] public int MaxGameMemory { get; set; }
    [JsonPropertyName("load_core_mods")] public bool LoadCoreMods { get; set; }
}