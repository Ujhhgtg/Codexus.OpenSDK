...
{
    [JsonPropertyName("sa_data")] public object SaData { get; set; }
    [JsonPropertyName("sauth_json")] public object SauthJson { get; set; }
    ...
    [JsonPropertyName("lock_time")] public long LockTime { get; set; }
