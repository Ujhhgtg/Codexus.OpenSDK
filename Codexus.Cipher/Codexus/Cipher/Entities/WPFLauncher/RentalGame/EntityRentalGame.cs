...
public class EntityRentalGame
{
    ...
    [JsonPropertyName("min_level")] public string MinLevel { get; set; } = string.Empty;
    [JsonPropertyName("pvp")] public bool IsPvpEnabled { get; set; }
    [JsonPropertyName("like_num")] public uint LikeCount { get; set; }
