...
public class EntityAuthenticationDetail
{
    ...
    [JsonPropertyName("app_ver")] public string AppVersion { get; set; }
    ...
    [JsonPropertyName("video_card3")] public string VideoCard3 { get; set; } = "";
    [JsonPropertyName("video_card4")] public string VideoCard4 { get; set; } = "";
    [JsonPropertyName("launcher_type")] public string LauncherType { get; set; } = "PC_java";
    [JsonPropertyName("pay_channel")] public string PayChannel { get; set; }
